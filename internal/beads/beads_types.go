...
// EnsureCustomTypesContext ensures the target beads directory has custom types
// configured using ctx for any bd subprocesses it may need to run.
func EnsureCustomTypesContext(ctx context.Context, beadsDir string) error {
	...
	if err := setBDConfigContext(ctx, beadsDir, bdEnv, "types.custom", customTypes); err != nil {
		return err
	}
	if err := setBDConfigContext(ctx, beadsDir, bdEnv, "types.infra", infraTypes); err != nil {
		return err
	}
	...
	if err := verifyBDConfigContext(ctx, beadsDir, bdEnv, "types.custom", customTypes); err != nil {
		return err
	}
	if err := verifyBDConfigContext(ctx, beadsDir, bdEnv, "types.infra", infraTypes); err != nil {
		return err
	}
...
func setBDConfig(beadsDir string, env []string, key, value string) error {
	return setBDConfigContext(context.Background(), beadsDir, env, key, value)
}

func setBDConfigContext(ctx context.Context, beadsDir string, env []string, key, value string) error {
...
func verifyBDConfig(beadsDir string, env []string, key, want string) error {
	return verifyBDConfigContext(context.Background(), beadsDir, env, key, want)
}

func verifyBDConfigContext(ctx context.Context, beadsDir string, env []string, key, want string) error {
