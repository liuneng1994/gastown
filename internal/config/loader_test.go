...
//  1. Set role_agents.mayor to each agent (claude, gemini, codex, trae, kiro, cursor, auggie, amp, opencode)
//  2. Run: gt start
...
// NOTE: Only these are actual built-in presets: claude, gemini, codex, trae, kiro, cursor, auggie, amp, opencode.
